...
namespace Noria.ViewModel
{
    public class FolderViewModel : INotifyPropertyChanged
    {
        ...
        private void SetDirectoryPathComponentChain()
        {
            ...
            {
                _pathComponentChain.Updated -= _pathComponentChain_LastLink_Updated;
                _pathComponentChain.Deleted -= _pathComponentChain_LastLink_Deleted;
            }
        ...
        private void _pathComponentChain_LastLink_Deleted(object sender, FileSystemPathComponentLinkDeletedEventArgs e)
        {
            MessageBox.Show(
                "THe current folder has been deleted. Navigating to closest existing containing folder.",
                "Error");
        ...
        private void _pathComponentChain_LastLink_Updated(object sender, FileSystemPathComponentLinkUpdatedEventArgs e)
        {
