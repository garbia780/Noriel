...
namespace Noria.UI
{
    ...
    //Todo: (Fixed) Fix problem where deleting the parent or ancestors of the folder in the current view causes nothing to happen, but creates an invalid application state.
